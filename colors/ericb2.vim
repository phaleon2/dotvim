...
let g:colors_name="ericb2"
hi Normal guifg=#ffba59 guibg=#292f36
hi Comment guifg=#80a0ff guibg=NONE
hi Constant guifg=#ff00ff guibg=NONE
hi String guifg=#ff4400 guibg=NONE
...
hi Function guifg=#fcbc26 guibg=NONE
hi Repeat guifg=#25cf44 guibg=NONE
